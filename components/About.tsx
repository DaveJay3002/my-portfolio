    ...
    >
      ...
      <div className="space-y-5 px-0 md:px-10 md:space-y-10 max-w-screen-md">
        ...
        <p className="text-sm md:text-base">
          I am Jay, and I am a Full Stack Developer and here are some things I
          have done so far.... <br />
          I started learning about coding in my first year of college and then I
          got all into it once I discovered Development and Competitive Coding.{" "}
          <br />
          Currently I am building projects for learning and leetcode for problem
          solving.
        </p>
      </div>
    </motion.div>
